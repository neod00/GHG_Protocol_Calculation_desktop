  ...
  const checklist: Array<Omit<ReportChecklistItem, "status">> = [
    {
      ...
      guidance: "회사명, 조직 경계, 운영 경계, 포함 범위를 명시해야 합니다."
    },
    {
      id: "approach",
      label: "조직 경계 접근법",
      ...
      guidance: "지분율, 재무 통제, 운영 통제 중 적용 접근법을 설명해야 합니다."
    },
    {
      id: "period",
      label: "보고 기간",
      ...
      guidance: "보고연도와 실제 보고기간을 일치하게 제시해야 합니다."
    },
    {
      id: "scope12",
      ...
      guidance: "Scope 1, Scope 2 location-based, Scope 2 market-based 합계를 제시해야 합니다."
    },
    {
      id: "methodology",
      label: "산정 방법론",
      ...
      guidance: "산정 방법, 배출계수 출처, 적용 원칙을 설명해야 합니다."
    },
    {
      id: "factors",
      label: "배출계수 및 출처",
      ...
      guidance: "사용한 배출계수의 기준 문서와 출처를 남겨야 합니다."
    },
    {
      id: "excluded",
      label: "제외된 배출원 및 활동",
      ...
      guidance: "제외된 항목이 없더라도 '없음' 또는 판단 근거를 남겨야 합니다."
    },
    {
      id: "baseYear",
      label: "기준연도 및 재산정 정책",
      ...
      guidance: "기준연도 선정 이유와 재산정 정책을 함께 제시해야 합니다."
    },
    {
      id: "verification",
      label: "검증 정보",
    ...
    },
    {
      ...
      guidance: "문의 가능한 담당자 이름과 부서 또는 연락수단을 넣어야 합니다."
    },
    {
      ...
      guidance: "선택 항목이지만 시설별 배출량은 실무 보고서 품질을 크게 높입니다."
    },
    {
      ...
      guidance: "검증 의견, 비율지표, 특이사항 등 선택 공시 항목을 확장할 수 있습니다."
    }
  ];
